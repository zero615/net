...
/**
 * The header fields of a single HTTP message. Values are uninterpreted strings; use {@code IntentRequest}
 * and {@code SharedResponse} for interpreted headers. This class maintains the order of the header fields
...
public final class Headers {
     ...
     */
    public static com.zero.support.net.Headers of(String... namesAndValues) {
        ...
        return new com.zero.support.net.Headers(namesAndValues);
    }

    /**
     * Returns headers for the header names and values in the {@link Map}.
     */
    public static com.zero.support.net.Headers of(Map<String, String> headers) {
    ...
    public static com.zero.support.net.Headers of(List<String> namesAndValues) {
        return of(namesAndValues.toArray(new String[0]));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof com.zero.support.net.Headers
                && Arrays.equals(((com.zero.support.net.Headers) other).namesAndValues, namesAndValues);
    }
    ...
    public static final class Builder {
         ...
         */
        public Builder addAll(com.zero.support.net.Headers headers) {
        ...
        public com.zero.support.net.Headers build() {
            return new com.zero.support.net.Headers(this);
        }
    }
}
